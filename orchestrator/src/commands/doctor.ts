/**
 * Doctor command for Orchestrator
...
export const doctorCommand: Command = {
  name: 'doctor',
  description: 'Run diagnostics and health checks on Orchestrator',
  handler: async (args: string[]) => {
    console.log('Running Orchestrator diagnostics...');
    console.log('✓ Configuration: OK');
    console.log('✓ State storage: OK');
    console.log('✓ Tool connections: OK');
